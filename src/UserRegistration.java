...
public class UserRegistration {
    ...
    public void registration(){
        ...
        scanner.nextLine();
        System.out.println("Checking your card number's validty...");
        cardNumberValid = analyseCardNumber(cardNumber);

        System.out.println("Please enter your CVV: ");
        cvv = scanner.nextInt();
        scanner.nextLine();
        System.out.println("Checking your card CvV's validty...");
        ...
        private boolean analyseEmail(String email){
            if(email.contains("@")&& email.contains(".")){
                ...
                System.out.println("Invaild email address.Going back to start of the registration.");
                registration();
        ...
        private boolean analyseAge(LocalDate dob){
            ...
            boolean isBirthday = (dob.getMonth().getValue() ==current.getMonthValue())&&(dob.getDayOfMonth() == current.getDayOfMonth());
